sap.ui.define(["com/kaar/ehal/eHauling_system/controller/BaseController"], function (BaseController) {
	"use strict";
	return BaseController.extend("com.kaar.ehal.eHauling_system.controller.TruckInfo", {

		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf com.kaar.ehal.eHauling_system.view.TruckInfo
		 */
		onInit: function () {	var sUrl = "/sap/opu/odata/sap/zppr_issuance_srv";
				var BenefitsSetModel1 = new sap.ui.model.odata.ODataModel(sUrl, true);
				this.getView().setModel(BenefitsSetModel1);
		},
		onPress:function(){
			this.getRouter().navTo("TruckDet",{},true);
		},
		onNavBack: function(){
